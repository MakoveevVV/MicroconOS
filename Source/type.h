...
/**
 * Структура для доступа к битам 32 слова
 * bit_0-bit_31: Биты отдельного регистра
 */
typedef struct
{
...
/**
 * Структура для доступа к битам 16 слова
 * bit_0-bit_15: Биты отдельного регистра
 */
typedef struct
{
		unsigned int bit_0 : 1;
